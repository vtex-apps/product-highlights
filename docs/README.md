...
| `link`       | `string`   | This will create a link using the `clusterHighlight` ID at the end of your string, can be used to access URL that are based on the `clusterHighlight`  | `undefined`   |
